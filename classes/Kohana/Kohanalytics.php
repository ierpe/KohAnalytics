...
abstract class Kohana_Kohanalytics {
    ...
    public function query($dimensions, $metrics, $sort_metric=null, $filter=null, $start_date=null, $end_date=null, $start_index=1, $max_results=30) {
        ...
        return $this->_gapi
                ->requestReportData($this->_config['report_id'], $dimensions, $metrics, $sort_metric, $filter, $start_date, $end_date, $start_index, $max_results)
//                ->getResults()
                ;
...
//            $sort = array($sort);
//        }
//        $results = $this->_gapi->requestReportData($this->_config['report_id'], $dimensions, $metrics, $sort_metric, $filter, $start_date, $end_date, $start_index, $max_results);
//        $data = array();
